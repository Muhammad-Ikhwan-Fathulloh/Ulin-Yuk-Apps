        ...
        <div class="row g-4">
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="service-item d-flex position-relative text-center h-100">
                    <img class="bg-img" src="{{secure_asset('img')}}/destinasi/caringin tilu.png" alt="">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="service-item d-flex position-relative text-center h-100">
                    <img class="bg-img" src="{{secure_asset('img')}}/destinasi/curug cilengkrang.png" alt="">
                    <div class="service-text p-5">
                        <img class="mb-4" src="{{secure_asset('img')}}/icons/icon-7.png" alt="Icon">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="service-item d-flex position-relative text-center h-100">
                    <img class="bg-img" src="{{secure_asset('img')}}/destinasi/air terjun cipanji.png" alt="">
                    <div class="service-text p-5">
                        <img class="mb-4" src="{{secure_asset('img')}}/icons/icon-7.png" alt="Icon">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="service-item d-flex position-relative text-center h-100">
                    <img class="bg-img" src="{{secure_asset('img')}}/destinasi/candi bojongemas.png" alt="">
                    <div class="service-text p-5">
                        <img class="mb-4" src="{{secure_asset('img')}}/icons/icon-7.png" alt="Icon">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="service-item d-flex position-relative text-center h-100">
                    <img class="bg-img" src="{{secure_asset('img')}}/destinasi/rumah adat cikondang.png" alt="">
                    <div class="service-text p-5">
                        <img class="mb-4" src="{{secure_asset('img')}}/icons/icon-7.png" alt="Icon">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="service-item d-flex position-relative text-center h-100">
                    <img class="bg-img" src="{{secure_asset('img')}}/destinasi/pemakaman boscha.png" alt="">
                    <div class="service-text p-5">
                        <img class="mb-4" src="{{secure_asset('img')}}/icons/icon-7.png" alt="Icon">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="service-item d-flex position-relative text-center h-100">
                    <img class="bg-img" src="{{secure_asset('img')}}/destinasi/cimanggu.png" alt="">
                    <div class="service-text p-5">
                        <img class="mb-4" src="{{secure_asset('img')}}/icons/icon-7.png" alt="Icon">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="service-item d-flex position-relative text-center h-100">
                    <img class="bg-img" src="{{secure_asset('img')}}/destinasi/bandung indah waterpark.png" alt="">
                    <div class="service-text p-5">
                        <img class="mb-4" src="{{secure_asset('img')}}/icons/icon-7.png" alt="Icon">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="service-item d-flex position-relative text-center h-100">
                    <img class="bg-img" src="{{secure_asset('img')}}/destinasi/valley resort.png" alt="">
                    <div class="service-text p-5">
                        <img class="mb-4" src="{{secure_asset('img')}}/icons/icon-7.png" alt="Icon">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="service-item d-flex position-relative text-center h-100">
                    <img class="bg-img" src="{{secure_asset('img')}}/destinasi/daarut tauhid.png" alt="">
                    <div class="service-text p-5">
                        <img class="mb-4" src="{{secure_asset('img')}}/icons/icon-7.png" alt="Icon">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="service-item d-flex position-relative text-center h-100">
                    <img class="bg-img" src="{{secure_asset('img')}}/destinasi/masjid raya bandung.png" alt="">
                    <div class="service-text p-5">
                        <img class="mb-4" src="{{secure_asset('img')}}/icons/icon-7.png" alt="Icon">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="service-item d-flex position-relative text-center h-100">
                    <img class="bg-img" src="{{secure_asset('img')}}/destinasi/gereja katedral.png" alt="">
                    <div class="service-text p-5">
                        <img class="mb-4" src="{{secure_asset('img')}}/icons/icon-7.png" alt="Icon">
