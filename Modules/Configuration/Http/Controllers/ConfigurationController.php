...
class ConfigurationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $this->_logHelper->store($this->module, $request->cooperation_category_name, 'create');
        DB::commit();
    ...
    public function update(Request $request, $id)
    {
        ...
        $this->_logHelper->store($this->module, $request->cooperation_category_name, 'update');
    ...
    private function _validationRules($id = '')
    {
        if ($id == '') {
            ...
            return [
                'key' => 'required|unique:configurations,key,' . $id . ',configuration_id',
            ];
        }
    }
}
